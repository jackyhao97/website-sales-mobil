<?php 
  ...
  $message = 'Halo Eben, Saya ingin bertanya simulasi kredit fuso. (sumber website)';
?>
...
<html lang="en">
  <head>
    ...
    <title>Mitsubishi Fuso Medan</title>
  </head>
  <body>
    <?php require_once '../navbar.php'; ?>

    <!-- Slider -->
    <div class="swiper swiper-mitsubishi-fuso" style="margin-top: 73px">
    ...
    <div class="container mt-5">
      <h2 class="text-uppercase mmc-bold text-center text-black">Harga Fuso Medan</h2>
      <p class="text-center text-muted">Lihat harga terbaru Fuso untuk wilayah Medan dan sekitarnya khusus untuk anda pengunjung website <a href="<?= BASE_URL; ?>" target="_blank">hargamitsubishimedanterbaik.com</a></p>
      <table class="table table-striped table-bordered table-width text-center">
        ...
        <tbody class="mmc-medium">
          <?php 
            $sql = $conn->query("SELECT tipe,harga FROM tb_harga WHERE merek = 'FUSO' AND discontinue = 0 ORDER BY harga");
      ...
      <p class="text-black mt-2 mmc-bold">Untuk info detail harga lebih lanjut dapat menghubungi kami disini <a href="https://wa.me/+6281260864570?text=Halo Bg Eben, Saya ingin bertanya lebih lanjut harga dari Fuso. (Sumber website)" class="text-success mmc-bold" target="_blank"><i class="fa fa-lg fa-whatsapp"></i> 0812-6086-4570</a></p>
    </div>
    <!-- Akhir Price -->
    ...
    <section class="video-colt mt-5 parallax-xpander">
      <div class="container-100 p-4 text-center text-white">
        <h1 class="mmc-bold">Video Fuso</h1>
        <p>Dapatkan video menarik tentang Mitsubishi Fuso berikut.</p>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/ZOZn_hZP2u4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
    </section>
    <!-- Akhir Video -->

    <h2 class="mmc-bold text-center mt-5 pt-4 text-white mb-0" style="background:black">Karoseri Fuso</h2>
    <div class="swiper swiper-exterior-fuso text-white pb-4" style="background:black">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img class="w-100" src="<?= BASE_URL.DS.'assets/img/fuso/karoseri/bak-besi.png'; ?>">
          <h4 class="text-center mmc-bold">Bak Besi</h4>
        </div>
        <div class="swiper-slide">
          <img class="w-100" src="<?= BASE_URL.DS.'assets/img/fuso/karoseri/bak-kayu.png'; ?>">
          <h4 class="text-center mmc-bold">Bak Kayu</h4>
        </div>
        <div class="swiper-slide">
          <img class="w-100" src="<?= BASE_URL.DS.'assets/img/fuso/karoseri/box-besi.png'; ?>">
          <h4 class="text-center mmc-bold">Box Besi</h4>
        </div>
        <div class="swiper-slide">
          <img class="w-100" src="<?= BASE_URL.DS.'assets/img/fuso/karoseri/car-carrier.png'; ?>">
          <h4 class="text-center mmc-bold">Car Carrier</h4>
        </div>
        <div class="swiper-slide">
          <img class="w-100" src="<?= BASE_URL.DS.'assets/img/fuso/karoseri/container.png'; ?>">
          <h4 class="text-center mmc-bold">Container</h4>
        </div>
        <div class="swiper-slide">
          <img class="w-100" src="<?= BASE_URL.DS.'assets/img/fuso/karoseri/dump-truck.png'; ?>">
          <h4 class="text-center mmc-bold">Dump Truck</h4>
        </div>
        <div class="swiper-slide">
          <img class="w-100" src="<?= BASE_URL.DS.'assets/img/fuso/karoseri/flat-bed.png'; ?>">
          <h4 class="text-center mmc-bold">Flat Bed</h4>
        </div>
        <div class="swiper-slide">
          <img class="w-100" src="<?= BASE_URL.DS.'assets/img/fuso/karoseri/tangki.png'; ?>">
          <h4 class="text-center mmc-bold">Tangki</h4>
        </div>
        <div class="swiper-slide">
          <img class="w-100" src="<?= BASE_URL.DS.'assets/img/fuso/karoseri/wingbox.png'; ?>">
          <h4 class="text-center mmc-bold">Wingbox</h4>
        </div>
      </div>
    </div>
    ...
    <div class="d-none d-sm-block container">
      <div class="row mt-5">
        <div class="col d-flex justify-content-center">
          <a href="<?=BASE_URL.DS.'assets/brochure/fuso.pdf'?>" class="btn btn-lg btn-danger me-2" target="_blank"><i class="fa fa-lg fa-download"></i> Download brochure</a>
    ...
    <div class="container d-block d-sm-none">
      <div class="row mt-5">
        <div class="col">
          <a href="<?=BASE_URL.DS.'assets/brochure/fuso.pdf'?>" class="btn btn-lg btn-danger mb-2 d-flex justify-content-center"><i class="fa fa-lg fa-download me-2"></i> Download brochure</a>
    ...
    <script>
      new Swiper(".swiper-mitsubishi-fuso", {
        autoplay: {
          delay: 3000,
      ...
      new Swiper(".swiper-exterior-fuso", {
        autoplay: {
          delay: 3000,
          disableOnInteraction: false,
        },
