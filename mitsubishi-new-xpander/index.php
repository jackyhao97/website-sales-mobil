<?php 
  ...
  $message = 'Halo Eben, Saya ingin bertanya simulasi kredit new xpander. (sumber website)';
?>
  ...
  <body>
    ...
    <script>
      ...
      if (window.matchMedia("(max-width: 576px)").matches) {
        ...
        $(".slider-2").attr('src','<?= BASE_URL.DS.'assets/img/promo-juni-mb.jpg' ?>')
      }
