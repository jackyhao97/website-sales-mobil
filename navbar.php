<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="background:black !important; border-bottom:3px solid red">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="<?=BASE_URL.DS.'assets/img/logo-jacky.png'?>" style="width: 200px"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav mmc-bold" style="font-size: 18px">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" style="background:black">
            <li><a class="dropdown-item text-white nav-product" href="./mitsubishi-new-xpander/"><img src="<?=BASE_URL.DS.'assets/img/thumbs/new-xpander-thumb.png'?>" style="width: 100px" class="me-4">NEW XPANDER</a></li>
      ...
      <a class="navbar-brand ms-auto d-none d-lg-block" href="#"><img src="<?=BASE_URL.DS.'assets/img/logo-sardana-putih.png'?>" style="width: 200px"></a>
    </div>
  </div>
</nav>